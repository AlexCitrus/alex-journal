...
class JournalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create journal' do
    assert_difference('Journal.count') do
      post journals_url, params: { journal: { name: @journal.name, user_id: @journal.user_id } }
    end
  ...
  test 'should update journal' do
    patch journal_url(@journal), params: { journal: { name: @journal.name, user_id: @journal.user_id } }
